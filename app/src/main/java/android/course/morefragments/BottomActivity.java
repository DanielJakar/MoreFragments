            ...
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    ...
                    fragmentManager.beginTransaction().
                            replace(R.id.content, new GalleryFragment()).commit();
                ...
                case R.id.navigation_notifications:
                    // 1) create new instance of the new fragment
                    TextFragment textFrag = TextFragment.newInstance("Hello, Parameters");

                    // 2) begin a transaction
                    getSupportFragmentManager().beginTransaction().replace(R.id.content, textFrag).commit();
